...
const messages = {
  'zh-CN': {
    ...
    landscape: '横向',
    margin: '页边距',
    optimizeLongPdf: '优化长文档（推荐）',
    optimizeLongPdfHint: '100 页以上自动使用适合阅读的分辨率，大幅降低耗时和文件体积。',
    splitHeight: '分片高度',
    exporting: '正在生成…',
    cancelExport: '取消导出',
    download: '下载',
  ...
  en: {
    ...
    landscape: 'Landscape',
    margin: 'Margin',
    optimizeLongPdf: 'Optimize long documents (recommended)',
    optimizeLongPdfHint: 'For 100+ pages, use a reading-friendly resolution to reduce time and file size.',
