...
export const changelogEntries: ChangelogEntry[] = [
  {
    ...
    items: {
      'zh-CN': [
        ...
        '所有专用工具页新增推荐设置恢复；完整重置会保留当前工具的输出契约，并支持在提示中撤销。',
      ],
      en: [
        ...
        'All purpose-built tools now offer recommended-setting recovery; a full reset preserves the active tool’s output contract and can be undone from the notification.',
      ],
      ja: [
        ...
        'すべての専用ツールで推奨設定に戻せるようになりました。全設定のリセット後も現在のツールの出力条件を維持し、通知から元に戻せます。',
      ],
    },
  },
  {
